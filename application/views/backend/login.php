  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
<?php
echo form_open('index.php/backend/cek_login')
?>
		      <div class="form-login">
		        ...
		        <div class="login-wrap">
		            ...
		            <input type="submit" class="btn btn-theme btn-block" href="index.html" value="SIGN IN"><i class="fa fa-lock"></i> 
		            <hr>
    ...
    <script type="text/javascript" src="<?php echo base_url('gui/backend/assets/js/jquery.backstretch.min.js');?>"></script>
    <script>
